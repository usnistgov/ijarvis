...
input.addEventListener("keyup", function(event) {
  ...
  //console.log(str);
  var inp = "";
  var inp = possibl_els(input.value);

  //console.log("The input was-keyboard", inp);
  var now_results, j, k;
  var f = inp.split("-").sort();
  var f = f.join("-");
  //console.log("input is", f);
  //location.reload()
...
(function() {
  ...
  [].forEach.call(speechInputWrappers, function(speechInputWrapper) {
    ...
    var inputRightBorder = parseInt(
      getComputedStyle(inputEl).borderRightWidth,
      10
    );
    ...
    recognition.onresult = function(event) {
      ...
      var inp = possibl_els(str);

      console.log("The input was", inp);
      ...
      var str1 = "Here are the results for";
      var str2 = str;
      var str3 = str1.concat(str2);

      speechSynthesis.speak(new SpeechSynthesisUtterance(str3));
